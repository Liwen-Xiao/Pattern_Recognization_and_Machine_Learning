...
class net_4544_sig(nn.Module):
    '''
    LeNet网络的类
    '''

    def __init__(self):
        super(net_4544_sig, self).__init__()
...
class net_4544_relu(nn.Module):
    '''
    LeNet网络的类
    '''

    def __init__(self):
        super(net_4544_relu, self).__init__()
        self.fc = nn.Sequential(
            nn.Linear(4, 5),
            nn.ReLU(),
            nn.Linear(5, 4),
...
class net_4544444_relu(nn.Module):
    '''
    LeNet网络的类
    '''

    def __init__(self):
        super(net_4544444_relu, self).__init__()
        self.fc = nn.Sequential(
            nn.Linear(4, 5),
            nn.ReLU(),
            nn.Linear(5, 4),
...
class net_4994_relu(nn.Module):
    '''
    LeNet网络的类
    '''

    def __init__(self):
        super(net_4994_relu, self).__init__()
        self.fc = nn.Sequential(
            nn.Linear(4, 9),
            nn.ReLU(),
            nn.Linear(9, 9),
...
lr, num_epochs = 0.01, 500  # 学习率和训练次数的指定
